...
# 🐋 _(1024 dims)_ Setup _backend + embeddings + reranker + pgsql + frontend_ Without the need of DOCKER 
...
# 🐋 _(384 dims)_ Setup backend with different bge embeddings model (bge-small) === No need for Docker 
